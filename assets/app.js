...
var productPage = {
  init: function(){
    ...
    if(is_touch_device() && $('.product_gallery').hasClass('popup-enabled--false')) {
      imageFunctions.zoom('.product_gallery');
      draggable = false;
    } else if(is_touch_device() == 0) {
...
$(function() {
  ...
  $('body').on('opened', '.js-remodal-lightbox', function() {
    ...
    if (activate_zoom) {
      imageFunctions.zoom('.js-remodal-lightbox', true, 1);
    }
